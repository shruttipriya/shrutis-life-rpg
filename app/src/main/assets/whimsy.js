(function(){
  ...
  style.textContent=`
    ...
    .app{position:relative;z-index:1;padding-top:22px}
    ...
    .hero:after{content:'✦';right:4px;top:-17px;font-size:120px;color:#ffe7a733;transform:rotate(10deg)}
    @keyframes twinkle{0%,100%{opacity:.35;transform:translateY(0)}50%{opacity:1;transform:translateY(-3px)}}
    .orb{border-radius:28px;box-shadow:0 0 0 5px rgba(255,183,223,.08),0 12px 35px rgba(240,123,184,.28);position:relative}
    ...
    .game-banner .emoji{filter:drop-shadow(0 0 8px rgba(255,183,223,.35))}
    ...
    .featured:after{content:'☽  ✦  ♡';position:absolute;right:14px;top:10px;color:#ffe7a744;font-size:14px;letter-spacing:4px}
    .questcard{border-radius:20px!important;position:relative;overflow:hidden}
    .questcard:after{content:'✦';position:absolute;right:7px;bottom:4px;color:#fff1c414;font-size:28px}
    ...
    .streak:after{content:'☄';position:absolute;right:18px;top:8px;color:#ffe39a25;font-size:58px;transform:rotate(-18deg)}
    .chest{border-radius:23px}
    .chest:before{content:'✧  ✦  ✧';position:absolute;right:18px;top:8px;color:#ffe7a744;letter-spacing:7px;font-size:13px}
    ...
    .tabs button{font-family:Georgia,serif;font-size:11px;transition:.15s}
    .tabs button.active{color:#fff1ca;text-shadow:0 0 12px rgba(255,210,130,.4);transform:translateY(-2px)}
    ...
    .questcard .check.done{box-shadow:0 0 18px rgba(114,227,173,.3)}
